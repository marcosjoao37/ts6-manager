...
const en: BotMessages = {
  ...
  removedTrack: (index, title) => `🗑️ Removed #${index}: ${title}`,
  playingIndex: (index, title) => `▶️ Playing #${index}: ${title}`,
  queueCleared: '🧹 Queue cleared.',
  queueUsage: 'Usage: !queue [show|play <n>|remove <n>|clear|<url>]',
  failedToQueue: (m) => `❌ Failed to queue: ${m}`,
  downloadCancelled: '🛑 Download cancelled.',
  noActiveDownload: 'ℹ️ No active download to cancel.',
  ...
  playbackStopped: '⏹️ Playback stopped.',
  paused: '⏸️ Paused.',
  nothingPlaying: '🎶 Nothing is playing.',
  skippedTo: (title) => `⏭️ Skipped to: ${title}`,
  queueEmptyStopped: '⏹️ Queue empty — playback stopped.',
  previousTrack: (title) => `⏮️ Previous: ${title}`,
  noPreviousTrack: '⏮️ No previous track.',
...
const ptBR: BotMessages = {
  ...
  removedTrack: (index, title) => `🗑️ Removida #${index}: ${title}`,
  playingIndex: (index, title) => `▶️ Tocando #${index}: ${title}`,
  ...
  noActiveDownload: 'ℹ️ Nenhum download ativo para cancelar.',
  ...
  playbackStopped: '⏹️ Reprodução parada.',
  paused: '⏸️ Pausado.',
  nothingPlaying: '🎶 Nada está tocando.',
  skippedTo: (title) => `⏭️ Pulado para: ${title}`,
  queueEmptyStopped: '⏹️ Fila vazia — reprodução parada.',
  previousTrack: (title) => `⏮️ Anterior: ${title}`,
  noPreviousTrack: '⏮️ Nenhuma faixa anterior.',
  volume: (value) => `🔊 Volume: ${value}%`,
